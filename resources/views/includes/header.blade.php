         ...
         <div class="mx-auto flex flex-wrap flex-row items-center justify-between">
             ...
             <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                 ...
                 <nav
                     ...
                     <a class="block cursor-pointer nav-1-2" href="{{ url('/clubs') }}">Clubs</a>
                     <a class="block cursor-pointer nav-1-2" href="{{ url('/players') }}">Players</a>
                     <a class="block cursor-pointer nav-1-2" href="{{ url('/managers') }}">Managers</a>
                     <a class="block cursor-pointer nav-1-2" href="{{ url('/stadiums') }}">Stadium</a>
                 </nav>
             </div>
